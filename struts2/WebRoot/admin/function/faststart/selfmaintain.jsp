...
<html>
	...
	<body style="text-align: center;font-family: 'microsoft yahei';padding-top:50px">
		...
		　　		var child = window.open("<%=path %>/admin.action?function=selfcarmanagement&page=1&value1=self", "newwin", "height=600, width=1000,toolbar=no,scrollbars="+scroll+",menubar=no");
