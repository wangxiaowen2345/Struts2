...
<html>
	...
	<body style="align: center; font-family: 'Microsoft YaHei';">
		...
		<div id="div1" style="margin-left: 2%; margin-top: 20px;">
			...
			<div id="content">
			<s:iterator value="ArrearsList()" var="ss">
				<s:set name="son" value="RepairByNum(#ss.number)"/>
				<div id="left">
				...
				<div id="right">
					<a href="<%=path %>/admin.action?function=payarrears&value2=<s:property value="#ss.id" />">结款</a>
