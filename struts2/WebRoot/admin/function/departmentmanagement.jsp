...
<html>
	...
	<body style="align: center; font-family: 'Microsoft YaHei';">
		...
		<div id="div1" style="margin-left: 2%; margin-top: 20px; width: 50%">
			...
			<s:iterator value="AllDepartment()" var="son">
				...
				<div id="middle" style="width: 50%;overflow: hidden; text-overflow:ellipsis;white-space:nowrap;">
					<s:property value="#son.departmentname" />
				</div>
				<div id="right" style="width: 25%;overflow: hidden; text-overflow:ellipsis;white-space:nowrap;">
					<a href='javascript:showUserData(<s:property value='#son.id' />,"<s:property value="#son.departmentname" />");'>修改</a>
				</div>
			</s:iterator>
			...
			<div id="dialog" style="height: 150px;">
				...
				<div align="center" id="dialogbody" style="height: 288px;">
					...
					<div
						...
						<input type="text" id="departmentname" style="width: 70%">
						</br>
	...
	function showUserData(sId,name) {
		tag = 1;
		Id = sId;
	...
	function AddPower(){
		...
		if(tag == 0)
		$.post("<%= path%>/admin.action?function=adddepartment", 
			{ value1:name},
   			function(data){
   				alert(data);
    			if(data=="\"Success\""){
   		...
   		$.post("<%= path%>/admin.action?function=updatedepartment", 
