...
<html>
	...
	<body
		style="align: center; font-family: 'Microsoft YaHei'; padding-top: 20px；margin-bottom :   150px;">
		...
		<div id="div1" style="margin-left: 1%; margin-top: 20px;">
			...
			<div id="content">
				<s:iterator value="AllPublicFastCarByTimdeDecs(page)" var="son">
					...
					<div id="middle" style="width: 10%">
						<a href='javascript:showInfo(<s:property value='#son.id' />,"1");'> <s:property
								value="#son.contractname" /> </a>
					</div>
					...
					<div id="right" style="width: 15%">
						...
						<a
							href='javascript:showData(<s:property value='#son.id' />,"<s:property value='ModelsById(#son.model).name' />");'>修改</a>&nbsp&nbsp&nbsp&nbsp
			...
			<div id="bottom" style="margin-bottom: 200px"></div>
		</div>
			...
			<div id="dialog" style="height: 550px; top: 205px; overflow-y: scroll;">
				...
				<div align="center" id="dialogbody">
					...
					<div style="width: 65%; float: right; display: inline; text-align: left; line-height: 30px;">
						...
						<input type="text" id="contractname" style="width: 70%; height: 21px">
						</br>
						<input type="text" id="contracttel" style="width: 70%; height: 21px">
						</br>
						<input type="text" id="contractaddress" style="width: 70%; height: 21px">
						</br>
						<input type="text" id="contractidentity" style="width: 70%; height: 21px">
						</br>
						<div class="input-append date" style="border: 0px; line-height: 30px; height: 30px" id="time1"
							...
							<span class="add-on" style="padding: 2px; border: 0px; background-color: #fff;"> <input
									size="14" type="text" value="" id="insurestart"> </span>
							<input type="hidden" id="dtp_input1" value="" style="height: 30px" />
						</div>

						<div class="input-append date" style="border: 0px; line-height: 30px;" id="time2" data-date=""
							data-date-format="dd-mm-yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
							<span class="add-on" style="padding: 2px; border: 0px; background-color: #fff;"> <input
									size="14" type="text" value="" id="insureexp"> </span>
							<input type="hidden" id="dtp_input2" value="" style="height: 30px" />
						</div>

						<input type="text" id="applicant" style="width: 70%; height: 21px">
						</br>
						<input type="text" id="insuretype" style="width: 70%; height: 21px">
						</br>
	...
	function update(){
		...
		var insureoffer = $("#insureoffer").val();
		var insurediscount = $("#insurediscount").val();
		var userdiscount =insureoffer*(1-insurediscount);
		var clientpay = $("#clientpay").val();
		var insuretype = $("#insuretype").val();
		var cartype = 0;
	...
	Date.prototype.Format = function(fmt)
		...
		$.post("<%=path%>/admin.action?function=fastfastcar",{value1:s},
    		function(data) {
     		var a ="data[i][0]";
     			for(var i = 0;i<data.length;i++){
     				var c = "<div id='left' style='width: 10%'>"
							...
							+"<a href='<%=path%>
	(" + data[i][10] + ",\""
						+ data[i][0] + "\");'>修改信息__tag_587$80_&nbsp&nbsp"
						+ "<a href='__tag_588$18_/fileUpload.action?value1="
						+ data[i][1] + "'>上传__tag_588$71_" + "__tag_589$9_";
